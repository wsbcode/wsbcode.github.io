...
const projects = [
   {
      title: "Projeto 1",
      desc: "Descrição breve do projeto, destacando o problema resolvido e as principais funcionalidades implementadas.",
      techs: ["React", "Node.js", "MongoDB"],
      github: "https://github.com/wsbcode",
      demo: "https://example.com",
      image: "src/assets/images/desenvolvimentos.png",
   },
   {
      title: "Projeto 2",
